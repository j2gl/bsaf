...
public class ActionManager extends AbstractBean {
    ...
    private final WeakHashMap<Object, ApplicationActionMap> actionMaps =
        new WeakHashMap<Object, ApplicationActionMap>();
     ...
     * @see #getActionMap()
     * @see #removeActionMap(Object)
     * @see ApplicationContext#getActionMap()
     * @see ApplicationContext#getActionMap(Class, Object)
     * @see ApplicationContext#getActionMap(Object)
     * @see ApplicationContext#removeActionMap(Object)
     */
    public ApplicationActionMap getActionMap(Class actionsClass, Object actionsObject) {
        ...
        synchronized (actionMaps) {
            ApplicationActionMap classActionMap = actionMaps.get(actionsObject);
            if ((classActionMap == null) || (classActionMap.getActionsClass() != actionsClass)) {
                ...
                actionMaps.put(actionsObject, classActionMap);
            }
    ...
    /**
     * Removes association between the {@code actionsObject} and obtained
     * by the {@link #getActionMap(Class, Object)} object.
     * To avoid memory leaks you should invoke this method if the {@code actionsObject} is
     * no longer used.
     * Note that the association will automatically be removed when
     * {@code actionsObject} is no longer in ordinary use.
     *
     * @see #getActionMap(Class, Object)
     * @see ApplicationContext#removeActionMap(Object)
     */
    public void removeActionMap(Object actionsObject) {
        if (actionsObject == null) {
            throw new IllegalArgumentException("null actionsObject");
        }
        synchronized (actionMaps) {
            actionMaps.remove(actionsObject);
        }
    }
    ...
    private final class KeyboardFocusPCL implements PropertyChangeListener {
        ...
        public void propertyChange(PropertyChangeEvent e) {
            ...
            updateAllProxyActions(newOwner);
        }
    }
     ...
     */
    private void updateAllProxyActions(JComponent newFocusOwner) {
        if (newFocusOwner != null) {
            ...
            if (ownerActionMap != null) {
                ...
                for (ApplicationActionMap applicationActionMap : actionMaps.values()) {
                    updateProxyActions(applicationActionMap, ownerActionMap, newFocusOwner);
                }
            }
        }
    }
