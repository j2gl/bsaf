...
import org.jdesktop.application.data.Storage;
...
public class ApplicationContext extends AbstractBean {
     ...
     * <p/>
     * This is just a convenience method that calls
     * {@link ActionManager#removeActionMap(Object)}. It's defined as:
     * <pre>
     * getActionManager().removeActionMap(actionsObject);
     * </pre>
     *
     * @see ActionManager#removeActionMap(Object)
     */
    public final void removeActionMap(Object actionsObject) {
        getActionManager().removeActionMap(actionsObject);
    }

    public final Storage getStorage() {
        if (storage == null) {
            storage = new Storage(getAppName(getApplicationClass()), getAppVendor());
        }
        return storage;
    }
    ...
    private String getResource(String name, String def) {
    ...
    private String getAppVendor() {
        return getResource("Application.vendorId", "UnknownVendor");
    }

    private String getAppName(Class<?> appClass) {
        return getResource("Application.id", (appClass != null)
