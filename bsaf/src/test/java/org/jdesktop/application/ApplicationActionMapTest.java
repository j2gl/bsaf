 ...
 */
public class ApplicationActionMapTest extends TestCase {
    public ApplicationActionMapTest(String testName) {
        super(testName);
    }

    public static class SimpleActions {
	@Action
	public void trivialAction() { }  // no properties in Controller.properties

	@Action
	public void allActionProperties() { }  // all possible properties in Controller.properties

	@Action(name="alternateActionName")
	public void notTheActionName() { }  

        // See testActionMnemonicProperties
        @Action public void checkActionMnemonics0() { }
        @Action public void checkActionMnemonics1() { }
        @Action public void checkActionMnemonics5() { }
	...
	@Action void actionParametersA(ActionEvent e) {
	    lastActionEvent = e;
	}
	@Action void actionParametersB(javax.swing.Action a) {
	    a.putValue("testKey", "testValue");
	}
	@Action void actionParametersAB(ActionEvent e, javax.swing.Action a) {
	    lastActionEvent = e;
	    a.putValue("testKey", "testValue");
	}
	...
	@Action void Hello() { helloWorldWriter.print("Hello "); }
	@Action void World() { helloWorldWriter.print("World"); }
     ...
     */
    public void NOtestActionParametersZ() {
	ApplicationActionMap appAM = simpleActionMap(resourceMap());
	// verify that the Action is in the SimpleActions ActionMap
