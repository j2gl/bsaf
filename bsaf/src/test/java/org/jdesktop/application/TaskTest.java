...
public class TaskTest extends TestCase {
    ...
    public static class SleepTask extends Task<String, Void> {
        ...
        synchronized int getCompletionMethod() {
            return completionMethod;
        }

        synchronized void setCompletionMethod(int i) {
            completionMethod = i;
        }
    ...
    public static class SleepTaskListener extends TaskListener.Adapter<String, Void> {
        ...
        synchronized TaskEvent getTaskEvent() {
            return taskEvent;
        }

        synchronized void setTaskEvent(TaskEvent e) {
            taskEvent = e;
        }
