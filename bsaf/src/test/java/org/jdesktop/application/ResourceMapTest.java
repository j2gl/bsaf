...
/*    public void testSupportedResourceTypes()
    ...
    private void checkBasicResourceMap(ResourceMap rm)
    {
        ...
        assertEquals("getFloat(\"" + float123 + "\")", rm.getFloat(float123).floatValue(), 123.0f,EPSILON_FLOAT);
        assertEquals("getDouble(\"" + double123 + "\")", rm.getDouble(double123).doubleValue(), 123.0,EPSILON_DOUBLE);
