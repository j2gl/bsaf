...
public class TestStringToPoint2D_Float
{
    public TestStringToPoint2D_Float() {} // constructor
    ...
    StringToPoint.StringToPoint2D_Float defaultConverter;

    @Before
    public void methodSetup()
    {
        defaultConverter = new StringToPoint.StringToPoint2D_Float();
    } // methodSetup()
    ...
    {
        String s = "20,40";
        Point2D.Float expected = new Point2D.Float(20, 40);
        Point2D.Float actual = defaultConverter.convert(s);
        assertEquals("Point2D.Float should reflect String value", expected, actual);
    }
    ...
    {
        String s = "100,222";
        Point2D.Float expected = new Point2D.Float(100, 222);
        Point2D.Float actual = defaultConverter.convert(s);
        assertEquals("Point2D.Float should reflect String value", expected, actual);
    }
